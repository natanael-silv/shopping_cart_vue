<template>
  <div class="md:grid grid-cols-2 mx-auto md:mt-20 my-0 md:w-[1000px] items-center">
    ...
    <section>
      ...
      <div class="flex items-center flex-col px-10 md:py-10">
        ...
        <button
          class="p-2 flex items-center justify-center bg-halloween rounded-md w-full mt-2 shadow-halloween shadow-lg"
